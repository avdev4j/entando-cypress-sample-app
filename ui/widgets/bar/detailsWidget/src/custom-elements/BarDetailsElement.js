...
class BarDetailsElement extends HTMLElement {
  constructor(...args) {
    super(...args);
  ...
  render() {
    const customEventPrefix = 'bar.details.';
    ...
    const ReactComponent = React.createElement(BarDetailsContainer, {
      id,
      onError,
      serviceUrl,
    });
...
customElements.define('bar-details', BarDetailsElement);
