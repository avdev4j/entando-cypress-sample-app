...
1. Go to widget source (<MICROSERVICE_FOLDER>/ui/widgets/bar/tableWidget/>):
    1. Run `npm i`
...
-   **bar.table.error** (fired when an error occurs)
-   **bar.table.select** (fired when a table row is selected)
