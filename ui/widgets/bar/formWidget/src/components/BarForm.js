...
import { formValues, formTouched, formErrors } from 'components/__types__/bar';
...
class BarForm extends PureComponent {
  ...
  render() {
    ...
    return (
      <form onSubmit={handleSubmit} className={classes.root} data-testid="bar-form">
...
const formikBag = {
  mapPropsToValues: ({ bar }) => bar || emptyBar,
